...
Heading = Label(root, text="TRACK NUMBER",fg="white", bg="#363062",
                font=("arial", 25, "bold"), justify="center")
Heading.place(x=43, y=110)

entry = StringVar()
enter_number = Entry(root, textvariable=entry, width=19, bd=0,
                     background="#827397", font=("arial", 15), justify="center")
enter_number.place(x=75, y=200)

search = Button(text="SEARCH", width=18, bd=1, fg="white", bg="#827397",
                font=("arial", 15), justify="center", command=track)
search.place(x=75, y=300)

country = Label(root, text="COUNTRY:", bg="#363062",
                fg="white", font=("arial", 10, "bold"))
country.place(x=50, y=400)

sim = Label(root, text="SIM:", bg="#363062",
            fg="white", font=("arial", 10, "bold"))
sim.place(x=200, y=400)

zone = Label(root, text="TIME ZONE:", bg="#363062",
             fg="white", font=("arial", 10, "bold"))
zone.place(x=50, y=450)

clock = Label(root, text="PHONE TIME:", bg="#363062",
              fg="white", font=("arial", 10, "bold"))
clock.place(x=200, y=450)

longitude = Label(root, text="LONGITUDE:", bg="#363062",
                  fg="white", font=("arial", 10, "bold"))
longitude.place(x=50, y=500)

latitude = Label(root, text="LATITUDE:", bg="#363062",
                 fg="white", font=("arial", 10, "bold"))
